...
Recordar que por defecto, se enviaron cuadernillos foliados sin ser preasignados a los estudiantes, es por esta razón que se debe realizar esta actividad,
:::
...
Actualmente, esta tabla es trabajada en un excel de modo de adaptarla a la estructura de t_estudiantes_0
Actualmente, esta tabla se deja en la ruta: `r ruta_asignacion_0`
...
2- Luego, en un archivo excel, generé a mano 35 folios sobres para cada asociación de mecanizador-dia y los pegué en la tabla t_mecanizado_0.
La idea es dejar la tabla vacía, con información solamente en la variable mec_0_folio_sobre, lo que sirve para actualizar el subformulario. 
...
4- La base de mecanizado se actualizará en la tabla **t_mecanizado_0**.\ 
### Operación
...
El folio sobre contiene información relevante:
- Sus primeros tres digitos corresponden al encargado de corrección
- Los últimos 3 dígitos corresponden al día programado de corrección  (no necesariamente coincidirá con la corrección real)
::: 
